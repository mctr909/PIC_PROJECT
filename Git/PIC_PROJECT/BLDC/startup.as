	...
	; HI-TECH C Compiler for PIC10/12/16 MCUs V9.80a
	...
	; Compiler options:
	;
	; -oBLDC.cof -mBLDC.map --summary=default --output=default main.p1 \
	; --chip=16F88 -IC:\Program Files (x86)\HI-TECH Software\PICC\9.80a\lib \
	; -IC:\Program Files (x86)\HI-TECH Software\PICC\9.80a\include -P \
